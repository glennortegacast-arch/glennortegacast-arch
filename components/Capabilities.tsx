          ...
          {items.map((item, i) => (
            <li key={item.title}>
              <Reveal delay={i * 80} className="h-full">
                <article className="group flex h-full flex-col gap-4 rounded-xl border border-line bg-cloud p-7 transition-all duration-300 hover:-translate-y-0.5 hover:border-ember/40 hover:bg-paper md:p-8">
                  <div className="flex items-baseline justify-between">
                    ...
                    <span
                      aria-hidden="true"
                      className="font-mono text-sm text-stone/40 transition-colors group-hover:text-ember"
                    >
                      ↗
                    </span>
                  </div>
